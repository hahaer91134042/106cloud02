...
int Java_tcnr_com_projectic_MjpegInputStream_pixeltobmp(JNIEnv* env,jobject thiz, jbyteArray jp, jint l, jobject bmp);
void Java_tcnr_com_projectic_MjpegInputStream_freeCameraMemory(JNIEnv* env,jobject thiz);
